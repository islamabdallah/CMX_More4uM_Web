...
namespace Repository.EntityFramework.Migrations
{
    ...
    [Migration("20240926135303_MedicalItems")]
    partial class MedicalItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MasterModels.Employee", b =>
                {
                    ...
                    b.Property<bool?>("HasMedicalService")
                        .HasColumnType("bit");

                    b.Property<bool?>("HasMore4uService")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.MedicalAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.MedicalRequest", b =>
                {
                    ...
                    b.Property<int>("MedicalRequestTypeId")
                        .HasColumnType("int");

                    b.Property<bool>("MonthlyMedication")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("RequestMedicalEntity")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ResponseFeedback")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ResponseMedicalEntity")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MedicalRequestTypeId");

                    b.ToTable("MedicalRequests");
                });

            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.MedicalRequestLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("MedicalRequestLogs");
                });

            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.MedicalRequestType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MedicalRequestTypes");
                });

            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.MedicalResponse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("MedicalResponses");
                });

            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.Relative", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ArabicRelation")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ArabicRelatives")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("BDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("CoverPercentage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.MedicalAttachment", b =>
                {
                    b.HasOne("MoreForYou.Models.Models.MedicalModels.MedicalRequest", "MedicalRequest")
            ...
            modelBuilder.Entity("MoreForYou.Models.Models.MedicalModels.MedicalRequest", b =>
                {
                    b.HasOne("MoreForYou.Models.Models.MedicalModels.MedicalRequestType", "MedicalRequestType")
                        .WithMany("medicalRequests")
                        .HasForeignKey("MedicalRequestTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MedicalRequestType");
                });
